...
public class StockEvent   {
  ...
  public StockEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public StockEvent datetime(String datetime) {
   ...
   * @return datetime
  */
  @ApiModelProperty(example = "2021-01-30 08:30", value = "")
...
@Pattern(regexp="^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) (2[0-3]|[01][0-9]):[0-5][0-9]$") 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StockEvent stockEvent = (StockEvent) o;
    return Objects.equals(this.id, stockEvent.id) &&
        Objects.equals(this.name, stockEvent.name) &&
        Objects.equals(this.datetime, stockEvent.datetime);
  }
